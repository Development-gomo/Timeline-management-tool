...
function MyProfilePage({ currentUserEmail, onUpdatePassword }) {
  ...
  return (
    <section className="rounded-[8px] border border-[#d7dfeb] bg-white p-6 shadow-[0_8px_24px_rgba(16,24,40,0.06)]">
      <div className="mb-6">
        ...
        <h2 className="m-0 text-[24px] leading-tight font-semibold text-[#070c11]">
          Change password
        </h2>
        {currentUserEmail ? (
          <p className="mt-2 text-sm font-semibold text-[#667085]">{currentUserEmail}</p>
        ) : null}
      </div>
      ...
      <form className="grid gap-5" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="rounded-[8px] bg-[#17b26a] px-5 py-3 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(23,178,106,0.16)] transition duration-200 hover:-translate-y-px disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:translate-y-0"
